...
import { TechnologyExpertiseCards } from "@/components/TechnologyExpertiseCards";
import { publicAsset } from "@/lib/public-asset";
import type { Technology, TechnologyExpertise } from "@/lib/portafolio-types";
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-5xl px-4 md:px-6">
        ...
        <TechnologyExpertiseCards items={technologyExpertise} />
