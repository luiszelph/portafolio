...
export const portafolioDataEng: PortafolioData = {
  ...
  projects: [
    ...
    },
    {
      id: "hermes-system",
      description:
        "Internal system for managing expenses generated by cargo orders, centralizing operational information, and simplifying reports for clients and billing teams.",
      details: [
        {
